...
(function () {
  ...
  const ICONS = {
    ...
    'check-square': '<rect x="3" y="4" width="18" height="18" rx="4"/><path d="M16 2v4M8 2v4M3 10h18"/><path d="M9 15l2 2 4-4"/>',
    ...
    chart: '<path d="M3 3v16a2 2 0 0 0 2 2h16"/><path d="M7 16v-5M12 16V8M17 16v-8"/>',
    ...
    heading: '<path d="M6 12h12"/><path d="M6 4v16M18 4v16"/>',
  ...
  window.PlannerIcons = { get, PRIORITY, has: (n) => n in ICONS };
})();